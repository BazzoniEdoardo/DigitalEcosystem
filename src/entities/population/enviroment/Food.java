package entities.population.enviroment;
...
public class Food extends AbstractRenderedEntity implements SimulationEntity, Updatable, Serializable {
    @Serial
    ...
    public boolean equals(Object o) {
        ...
        return id == food.id && Float.compare(nutrition, food.nutrition) == 0 && expired == food.expired && Objects.equals(position, food.position);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, nutrition, expired, position);
    }
